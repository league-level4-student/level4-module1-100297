...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Eat the apples, do not hit yourself with yourself";
	...
	private void setFoodLocation() {
		...
		Location a = new Location(ran.nextInt(WIDTH), ran.nextInt(HEIGHT));
	...
	private void gameOver() {
		...
		if (JOptionPane.showConfirmDialog(null, "Do you want to play again") == 0) {
			...
			foodLocation.y = ran.nextInt(HEIGHT);
		} else {
			window.dispose();
		}
